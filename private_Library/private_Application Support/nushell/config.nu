...
$env.config = {
    ...
    table: {
        mode: rounded # rounded basic, compact, compact_double, light, thin, with_love, rounded, reinforced, heavy, none, other
...
# 
# 
# #let  zsh_completer2 = {|spans|
# #
# #   #$spans.0: { } # default
# #   brew: {  carapace-bridge _carapace nushell '' zsh $spans | from json }
